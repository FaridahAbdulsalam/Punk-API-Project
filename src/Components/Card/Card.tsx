  ...
  return (
    <div className="card">
      ...
      <div className="card__content">
        ...
        {!showInfo && (<div className="card__button">
          <button onClick={hancleClick} className="card__info-open">Check out Ingredients</button>
        </div> )}

        {showInfo && (
          <div className="card__info">
            <img src={Cross} className="card__info-close" onClick={hancleClick}/>
            <p>{ingredients}</p>
          </div>
        )}
      </div>
